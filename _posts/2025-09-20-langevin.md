...
Having studied properties of the Langevin equation, we now proceed to the generalized one. We repeat it here for convenience, using velocity $v(t)$ instead of momentum $p(t)$:
